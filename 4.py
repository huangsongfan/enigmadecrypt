...
if __name__ == '__main__':
    ...
    # load values to rotor instances
    ...
    bank_3.load("abcdefghijklmnopqrstuvwxyz", "zxbcdefghijklosrtuvwaynmpq", False)
    ...
    # iterate, forward and reverse over rotors
    for i in range(0, 26):
        for j in range(0, 26):
            for k in range(0, 26):
                for l in range(0, 26):
                    for h in range(0, ins):
                        ...
                        Rotor_Char_Return_Value = bank_3.forward(Rotor_Char_Return_Value, position_3)
                        Rotor_Char_Return_Value = bank_9.forward(Rotor_Char_Return_Value, 0)
                        Rotor_Char_Return_Value = bank_3.reverse(Rotor_Char_Return_Value, position_3)
                        ...
                        output[h] = Rotor_Char_Return_Value

                    Value_Phi = Calculator_Phi(output, ins)

                    if Value_Phi > 0.038:
                        print("Value Of Phi: " + str(Value_Phi) + "\n")
                        print("Rotor 1:" + str(position_0) + ", Rotor 2:" + str(position_1) + "Rotor 3:" + str(position_2) + "Rotor 4:" + str(position_3) + "\n")
    ...
    # print out rotor key and Decrypted message
